...
ogr2ogr -f "PostgreSQL" PG:"host=localhost user=postgres password=postgres dbname=osmbuildings_miami port=5432" -skipfailures -lco GEOMETRY_NAME=geom $1"/Block_Groups_2010.shp"